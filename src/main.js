...
const store = new Vuex.Store({
  ...
  mutations: {
    setDancesUrl (state, value) {
      state.dances.url = value
    },
    setDancenotationsUrl (state, value) {
      state.dancenotations.url = value
    },
    setLexiconUrl (state, value) {
      state.lexicon.url = value
    },
